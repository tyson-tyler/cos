...
export default function Workoutsection() {
  return (
    <div className="bg-white min-h-screen mt-16 mb-16  flex flex-col lg:flex-row-reverse items-center justify-around px-8 lg:px-16 py-12">
              ...
              {[
                ...
                >
                  <Image
                    ...
                    width={250}
                    height={240}
                    className=" rounded-md h-[300px] object-cover hover:scale-105 transition"
                  />
                </div>
              ))}
            </div>
